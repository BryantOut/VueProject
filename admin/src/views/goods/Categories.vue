    ...
    <el-dialog title="收货地址" :visible.sync="addGoodsFormVisible">
      <el-form :model="addFrom">
        ...
        <el-form-item label="活动区域" :label-width="formLabelWidth">
          <el-cascader v-model="selectedOptions" :options="categoriesList" change-on-select :props="categoriesProps"></el-cascader>
        </el-form-item>
      </el-form>
  ...
  methods: {
    ...
    addGoodsSubmit() {
      ...
      if (this.selectedOptions.length === 0) {
        ...
        this.addFrom.cat_level = 1;
        this.addFrom.cat_pid = this.selectedOptions[0];
      } else {
        this.addFrom.cat_level = 2;
        this.addFrom.cat_pid = this.selectedOptions[1];
      }

      addCategories(this.addFrom).then(res => {
        console.log(res);

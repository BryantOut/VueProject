<template>
  <div class="role">
    ...
    <el-button type="success" plain @click="showAddRoleDialog">添加用户</el-button>
    ...
    <!-- 添加角色模态框 -->
    <el-dialog title="添加角色" :visible.sync="isShowAddRoleDialog" width="30%">
      <el-form ref="addRoleFrom" :model="addRoleForm" label-width="80px" :rules="rules">
